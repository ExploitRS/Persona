...
const Nav = (props: NavProps) => {
    ...
    return (
        <nav className='cy-blue-mid sticky-nav flex justify-between items-center max-w-4xl w-full p-8 my-0 md:my-8 mx-auto opacity-80'>
            <div className='container flex flex-wrap items-center justify-between mx-auto'>
                <Link to="#" className='flex items-center'>
                    {/* <img src="logo.svg" className='h-6 mr-3 sm:h-10' alt="logo of Exploit.RS" /> */}

                    <span className='self-center text-xl text-cy-blue-light font-semibold whitespace-nowrap'>{title}</span>
                </Link>
